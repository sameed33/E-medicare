...
$query = "select * from hospitaldetails where hospid='$hospid'";
          ...
          <div class="col-lg-8">
            ...
            <div class="row" align="center">
              <div class="col-sm-6">
                <div class="card">
                  <h3>Add blood</h3>
                    <a href="addblood.php"><button class="btn btn-secondary" name="dashboard">Add</button></a><br>
                </div>
              </div>
              ...
              <div class="col-sm-6">
                <div class="card">
                  <h3>Pending Blood Request</h3>
                  <form action="viewbloodrequests.php">
                    <button class="btn btn-secondary" name="viewrequests">View</button>
                  </form>
                  <br>
                </div>
              </div>

              <div class="col-sm-6 offset-xl-3"><br>
                <div class="card">
                  <h3>Search Donors</h3>
                  <form action="donors.php">
                    <button class="btn btn-secondary" name="viewdonor">View</button>
                  </form><br>
                  </div>
                </div>
                 ...
                 <div class="col-sm-6 offset-xl-3"><br>
                <div class="card">
                  <h3>Blood Requests History</h3>
                  <form action="viewallrequest.php">
                    <button class="btn btn-secondary" name="viewallrequest">View</button>
                  </form>
                  <br>
                </div>
