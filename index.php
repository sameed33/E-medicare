                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                                <input type="text" class="form-control search-slt" placeholder="State">
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                                <input type="text" class="form-control search-slt" placeholder="Countrie">
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <center><img src="camp.jpg" alt="Italian Trulli">
                            <center>
                    </div>
                </div>
            </div>
